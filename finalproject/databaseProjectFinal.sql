...
--Inserrer des donnees dans les tables (incluant des variables php)
...
--selectionner des donnees dans la view
SELECT * FROM history;




--EXAMPLE DE DONNEES POUR TESTER MANUELLEMENT ------------------------
INSERT INTO player(fName, lName, userName, registrationTime)
